...
We base our Theme: Master Azure Active Directory on Planning a [Minimum Viable Nothing (MVN)](https://github.com/vanHeemstraSystems/minimum-viable-nothing).

## 2. Find the **Opportunities**.

See [Learning - Azure Active Directory](https://vanheemstrasystems.github.io/learning-azure-active-directory/)
